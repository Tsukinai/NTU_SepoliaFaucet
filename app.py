...
def verify_code():
    ...
    print(f'Hash verification code: {hash_code(code)}')
    print(f'Verification code get from session: {session.get('verification_code')}')
    print(f'User address: {user_address}')
    print(f'Email: {email}')
    print(f'Email get from session: {session.get('email')}')
